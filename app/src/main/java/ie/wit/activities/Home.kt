...
class Home : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        app = application as LokationApp
...
//        }
        ...
        val fragment = LokateFragment.newInstance()
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.nav_lokate ->
                navigateTo(LokateFragment.newInstance())
            R.id.nav_report ->
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray) {
        ...
        Log.v("Lokation", "Home LAT: ${app.currentLocation.latitude} LNG: ${app.currentLocation.longitude}")
    }
}
